...
def greet_user(name: str) -> str:
    ...
    # пиши код здесь
    greetings = ["Привет", "Здравствуйте", "Добрый день", "Рады вас видеть"]
...
def is_phone_correct(phone_number: str) -> bool:
    ...
    # пиши код здесь
    result = bool(re.match(r'\+7[0-9]{10}', phone_number))
    return result
...
def moderate_text(text: str, uncultured_words: Iterable[str]) -> str:
    ...
    # пиши код здесь
    result = " ".join(text.translate({ord(i): None for i in "\"\'"}).split())
...
def create_request_for_loan(user_info: str) -> str:
    ...
    # пиши код здесь
    surname, name, patronym, dob, amount = user_info.split(',')
